...
ALLOWED_HOSTS = ["bank-9vhl.onrender.com", "www.bank-9vhl.onrender.com", "127.0.0.1"]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_processors.account_number',
                'accounts.context_processors.account_type',
